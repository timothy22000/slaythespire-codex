...
1024-D unit-normalized text embeddings for every card in **Slay the Spire**, produced by *inference* with the pretrained [`Qwen/Qwen3-Embedding-0.6B`](https://huggingface.co/Qwen/Qwen3-Embedding-0.6B) (frozen — no fine-tuning was done to generate this dataset).
